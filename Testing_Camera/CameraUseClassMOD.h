...
//		frame=convertNow.ConvertingChar2Mat(data);
 ...
 //		frame = data;
		...
		*/
		...
		//Mat testing = 0;
		//Mat testing(height,width,CV_8UC3, Scalar(0,0,100));
//		Mat testing = imread("Bottle_image.ppm", IMREAD_COLOR);
//		cout << "image loaded" << endl;

		//imshow("test", testing);
		//waitKey();

//		cout << "created Mat::ones" << endl;
		
		//cvtColor(testing, testing, COLOR_BGR2HSV);

		//printf("%u", testing.at<Vec3b>(5,5)[1]);

		//RNG::fill(test, RNG::UNIFORM,{100,100,100},{10,20,30},);
		//cout << "passed CONVERT" << endl;
		
		

//		imwrite("ClassifiableImage.ppm",testing);
